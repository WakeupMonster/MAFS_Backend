...
//     // 1. Try to get cached KPIs first
//     const cachedKpis = await Redis.get(cacheKey);
//     if (cachedKpis) {
//       return res.json(JSON.parse(cachedKpis));
//     }

//     // 2. Cache Miss - Execute DB queries
//     const now = new Date();
//     const last24Hours = new Date(now.getTime() - 24 * 60 * 60 * 1000);
...
//     // 3. Save to Redis (Cache for 2 minutes - 120 seconds)
//     // KPIs don't usually need to be real-time to the second
