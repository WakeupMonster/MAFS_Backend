...
router.post('/register-token', apiLimiter("notif_register", 5, 3600), notificationController.registerDeviceToken);
// Unregister device token
router.delete('/unregister-token', apiLimiter("notif_unregister", 5, 3600), notificationController.unregisterDeviceToken);
