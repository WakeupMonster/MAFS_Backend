module.exports.prizeDeliveredEmailTemplate = (prizeTitle) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <table width="100%" max-width="600" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
          <tr>
            <td style="padding: 40px 30px; text-align: center;">
              <h2 style="color: #ff3366; margin: 0 0 15px 0; font-size: 24px; font-weight: 700;">Congratulations 🎉</h2>
              <p style="color: #475569; font-size: 16px; line-height: 1.6; margin: 0 0 25px 0;">
                Your prize <strong>"${prizeTitle}"</strong> has been successfully delivered.
              </p>
